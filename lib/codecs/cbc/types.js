...
/**
 * Field codec definition. Certain type-specific properties are required.
 * @memberof cbc.types
 ...
 * @property {FieldCodec[]} [fields] Required for `struct`, `array` 
 *    and `bitkeylist`
 ...
 * @property {String} direction The MessageDirection
 * @property {number} messageKey A 16-bit message codec identifier
 * @property {Object<string, any>} value The key/value map of the field values
 */

/**
 * CBC Codec (file) definition
 * @memberof cbc.types
 * @typedef {Object} CbcCodec
 * @property {String} application
 * @property {String} [version]
 * @property {String} [description]
 * @property {MessageCodec[]} messages
 */

// Only export the enum definitions explicitly, others are type checking only
module.exports = {
  FieldType,
  MessageDirection,
};
